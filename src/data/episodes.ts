...
export const episodes: Episode[] = [
  ...
  { id: 'KuoooDT9_vo', order: 2, rubric: 'SPECIAL', title: 'Патронният празник на нашето училище', date: '2025-11-25' },
  ...
  { id: '6VzfCV5J_L0', order: 10, rubric: 'Междучасие', title: 'Как да съчетаем фитнес, училище и работа', date: '2026-03-06' },
  { id: 'M-ynZ1ijkJE', order: 11, rubric: 'Междучасие', title: 'С какво се занимаваме извън ученето?', date: '2026-05-07' },
